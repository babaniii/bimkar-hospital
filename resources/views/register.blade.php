    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="alamat" class="block mt-1 w-full" type="text" name="alamat"
                :value="old('alamat')" required autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="no_ktp" class="block mt-1 w-full" type="text" name="no_ktp"
                :value="old('no_ktp')" required autofocus autocomplete="name" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="no_hp" class="block mt-1 w-full" type="text" name="no_hp"
                :value="old('no_hp')" required autofocus autocomplete="name" />
